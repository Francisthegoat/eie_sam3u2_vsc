...
static void UserApp1SM_Idle(void) {
    ...
    if (InputIndex == 4) {
        ...
        if (Match) {
            ...
            const u8 aau8EngenuicsLogoBlackQ2[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
            {0x4C, 0xC1, 0x01, 0x00, 0x60, 0x00, 0x00},
            {0x54, 0x49, 0x00, 0x00, 0x14, 0x00, 0x00},
            {0x8C, 0xC1, 0x4E, 0x8C, 0x21, 0x00, 0x00},
            {0x14, 0x49, 0xA2, 0x54, 0x44, 0x00, 0x00},
            ...
            LcdLoadBitmap(&aau8EngenuicsLogoBlackQ2[0][0], &sAtcoLogo1);
            ...
            LcdLoadBitmap(&aau8EngenuicsLogoBlackQ4[0][0], &sWifilogo);							
